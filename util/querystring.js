...
define([], function () {
	...
	var exports = {};
	if (typeof require !== 'undefined' && require.nodeRequire) {
		platformQuerystring = require.nodeRequire('querystring');
		for(var i in platformQuerystring){
			exports[i] = platformQuerystring[i];
		}
	}
