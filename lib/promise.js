...
/**
 * Promise instances are frozen this allows repl representations be monkey-patched in
 */
exports.setRepr = function(value, key) {
    key = key || "toRepr";
    // TODO use es5-shim?
...
exports.whenApply = function(target, resolvedCallback, rejectCallback, progressCallback) {
	...
	try {
		return exports.when(target.apply(thisp, args), resolvedCallback, rejectCallback, progressCallback);
	}
	catch (e){
