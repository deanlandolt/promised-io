...
try {
	...
	for(var i in querystring) exports[i] = querystring[i];
}
catch (e) {}
...
// HACK a slightly modified version of jack's querystring module
// TODO just keep the good stuff and integrate node's lower-level querystring.js code
